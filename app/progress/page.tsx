    ...
    <section className="grid">
      ...
      <div className="grid grid-cols-2">
        <article className="card">
          <h3 style={{ marginTop: 0 }}>Paivat jolloin palasit (30 pv)</h3>
          <p style={{ fontSize: "1.8rem", margin: "0.3rem 0" }}>{snapshot.activeReviewDays30}</p>
        </article>
        <article className="card">
          <h3 style={{ marginTop: 0 }}>Hyvaksytyt kortit (30 pv)</h3>
          <p style={{ fontSize: "1.8rem", margin: "0.3rem 0" }}>{snapshot.cardsAccepted30}</p>
        </article>
        <article className="card">
          <h3 style={{ marginTop: 0 }}>Taman paivan liike</h3>
      ...
      <div className="grid grid-cols-2">
        <article className="card">
          <h3 style={{ marginTop: 0 }}>Paluun rytmi</h3>
        ...
        <article className="card">
          <h3 style={{ marginTop: 0 }}>Mita otit kayttoon</h3>
          <svg viewBox="0 0 1000 150" width="100%" height="150">
